...
export default function MyInfoBoardCard({ boardData, handleDelete }: BoardCardProps) {
    ...
    <div className="board-box flex">
      ...
      <div className="right-area flex-col align-end justify-between">
        ...
        <div className="button-box align-center gap-4">
          <Button onClick={() => handleDelete(boardBasicResponseDto.boardGuid)} size="small" color="primary">
            삭제
          </Button>
          <Button
            onClick={(e) => {
              e.stopPropagation();
              navigate(`/boards/update/${boardBasicResponseDto.boardGuid}`);
            }}
            size="small"
            variant="outlined"
            color="primary"
