...
export const updatePassword = (req: UpdatePasswordRequest) => fetcher<void, UpdatePasswordRequest>('/auth/password', req, { method: 'put' });
...
export const getUserBoards = (req: BoardSearchRequest) => {
  ...
  return fetcher<BoardSummary>(`/user/profile/boards?${searchParams.toString()}`, undefined, { method: 'get' });
};
