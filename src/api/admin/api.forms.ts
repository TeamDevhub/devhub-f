...
export const selectForms = (req: RequestSelectForms) =>
    fetcher<FormItem, RequestSelectForms>(`/admin/form/list`, req, { method: 'get' });

export const saveForm = (req: RequestSaveForm) =>
    fetcher<void, RequestSaveForm>(`/admin/form`, req, { method: 'put' });

export const deleteForm = (applicationFormGuid: string) =>
    fetcher<void, string>(`/admin/form/${applicationFormGuid}`, applicationFormGuid, { method: 'delete' });
