...
import MyProfileHome from '@/pages/profile/home';
import MyProfileUpdateWrapper from '@/pages/profile/update';
import MyProfileProjectListPage from '@/pages/profile/projects';
import MyProfileBoardList from '@/pages/profile/boards';
